...
RSpec.describe "Download real-time updates", type: :system do
  before do
    ...
    allow(adapter).to receive(:fetch_chapters).and_return([
      ...
      { id: "ch3", chapter: "3", volume: "1", language: "en" }
    ])
  ...
  it "progress bar updates and completes", :js do
    ...
    # Download completes — page reloads showing completed status
    expect(page).to have_css("#completed-downloads", text: "Test Manga", wait: 10)
  end

  it "starts progress bar at 0%", :js do
